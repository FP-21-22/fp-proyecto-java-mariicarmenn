...
public class EstudioClinicoBucles implements EstudioClinico {
	...
	//Tipo EstudioClinicoBucles que crea lista sin ningún elemento.
	public EstudioClinicoBucles() {
		this.ls = new ArrayList<>();
	}
	
	//Tipo EstudioClinicoBucles qie crea lista con objetos del tipo PacienteEstudio como parámetro.
