...
public record Vacunacion(LocalDate fecha, String comunidad, Integer pfizer, Integer moderna, Integer astrazeneca, Integer janssen, Integer numeroDePersonas) {
	...
	//RESTRICCIONES
	public Vacunacion{
		Checkers.check("La fecha tiene que ser posterior al 01/02/2021", fecha.isAfter(LocalDate.of(2021, 2, 1)));
	}
	...
	public static Vacunacion of(String cadena) {
	...
	public static void main(String[] args){
		Vacunacion v1 = Vacunacion.of("04/01/2021;Andalucía;140295;0;0;0;0");
